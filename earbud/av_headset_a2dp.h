...
#define appA2dpSetTransitionLockBit(theInst) (theInst)->a2dp.lock |= 1U
/*! \brief Clear A2DP lock bit for transition states */
#define appA2dpClearTransitionLockBit(theInst) (theInst)->a2dp.lock &= ~1U
/*! \brief Set A2DP lock bit waiting for kymera operations  */
#define appA2dpSetKymeraLockBit(theInst) (theInst)->a2dp.lock |= 2U
/*! \brief Set A2DP lock bit waiting for kymera operations  */
#define appA2dpClearKymeraLockBit(theInst) (theInst)->a2dp.lock &= ~2U
