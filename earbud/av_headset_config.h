...
/*! Default MIC gain.
    The range is 0 to #CODEC_INPUT_GAIN_RANGE */
#define appConfigMicGain()          (18)

/*! Default MIC input gain enable.
    Define whether to enable additional gain on the MIC input */
#define appConfigMicPreAmpGain()    (TRUE)
...
/*! Timeout for disconnecting handset, when earbud is out of the case
    and ear, and has no active audio. 
    Set a value of 0 to disable handset disconnection due to idleness. */
#define appConfigIdleHandsetDisconnectTimeoutMs()   D_SEC(0)
