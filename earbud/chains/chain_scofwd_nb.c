...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(SFWD_CAP_ID_SWITCHED_PASSTHROUGH, OPR_SWITCHED_PASSTHROUGH_CONSUMER),
    MAKE_OPERATOR_CONFIG_PRIORITY_HIGH(SFWD_CAP_ID_ASYNC_WBS_ENC, OPR_SCOFWD_SEND),
    MAKE_OPERATOR_CONFIG(CAP_ID_CVCHS1MIC_SEND_WB, OPR_CVC_SEND),
    MAKE_OPERATOR_CONFIG_PRIORITY_LOW(CAP_ID_RESAMPLER, OPR_SCO_UP_SAMPLE),
...
static const operator_endpoint_t outputs[] =
{
    ...
    {OPR_SCOFWD_SEND, EPR_SCOFWD_TX_OTA, 0}
};

static const operator_connection_t connections[] =
{
    {OPR_SCO_RECEIVE, 0, OPR_CVC_RECEIVE, 0, 1},
    {OPR_CVC_RECEIVE, 0, OPR_SCO_UP_SAMPLE, 0, 1},
    {OPR_SCO_UP_SAMPLE, 0, OPR_SOURCE_SYNC, 0, 1},
    {OPR_SOURCE_SYNC, 0, OPR_VOLUME_CONTROL, 0, 1},
    {OPR_VOLUME_CONTROL, 0, OPR_SCOFWD_SPLITTER, 0, 1},
    {OPR_SCOFWD_SPLITTER, 0, OPR_SCO_AEC, 0, 1},
    {OPR_SCOFWD_SPLITTER, 1, OPR_SWITCHED_PASSTHROUGH_CONSUMER, 0, 1},
    {OPR_SWITCHED_PASSTHROUGH_CONSUMER, 0, OPR_SCOFWD_SEND, 0, 1},
    {OPR_SCO_AEC, 3, OPR_CVC_SEND, 1, 1},
    {OPR_CVC_SEND, 0, OPR_SCO_SEND, 0, 1},
    {OPR_SCO_AEC, 0, OPR_CVC_SEND, 0, 1}
};

const unsigned chain_scofwd_nb_exclude_from_configure_sample_rate[] =
{
    OPR_SCOFWD_SPLITTER,
    OPR_SCOFWD_SEND
};
