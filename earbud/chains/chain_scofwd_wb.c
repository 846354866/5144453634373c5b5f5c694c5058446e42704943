/*!
    ...
    \brief The chain_scofwd_wb chain. This file is generated by C:/qtil/ADK_QCC512x_QCC302x_WIN_6.2.70/tools/chaingen/chaingen.py.
*/
...
const unsigned chain_scofwd_wb_exclude_from_configure_sample_rate[] =
{
    OPR_SCOFWD_SPLITTER,
    OPR_SCOFWD_SEND
};

const chain_config_t chain_scofwd_wb_config = {1, 0, operators, 10, inputs, 3, outputs, 3, connections, 10};
